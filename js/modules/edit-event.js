export function editEvent() {
    ...
    const eventPosts = Vue.createApp({
        created(){
            fetch(`http://localhost/AnonyGhosts_FoundationSixty6/lumen/public/events/${eventID}`)
    ...
    function updateEvent(event) {
        ...
        const url = `http://localhost/AnonyGhosts_FoundationSixty6/lumen/public/events/edit/${partnerID}`
        const thisform = this
