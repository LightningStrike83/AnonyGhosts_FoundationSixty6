export function addnewEntry() {
    ...
    function addNewEvent(event) {
        ...
        const url = `http://localhost/AnonyGhosts_FoundationSixty6/lumen/public/events/add`
        const thisform = this
    ...
    function addNewBlog(event) {
        event.preventDefault()
        const url = `http://localhost/AnonyGhosts_FoundationSixty6/lumen/public/blog_posts/add`
        const thisform = this
    ...
    function addNewVolunteer(event) {
        event.preventDefault()
        const url = `http://localhost/AnonyGhosts_FoundationSixty6/lumen/public/volunteers/add`
        const thisform = this
    ...
    function addNewCareer(event){
        event.preventDefault()
        const url = `http://localhost/AnonyGhosts_FoundationSixty6/lumen/public/careers/add`
        const thisform = this
    ...
    function addNewPartner(event) {
        event.preventDefault()
        const url = `http://localhost/AnonyGhosts_FoundationSixty6/lumen/public/partners/add`
        const thisform = this
