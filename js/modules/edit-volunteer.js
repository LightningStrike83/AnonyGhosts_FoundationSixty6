export function editVolunteer() {
    ...
    const volunteerInfo = Vue.createApp({
        created(){
            fetch(`http://localhost/AnonyGhosts_FoundationSixty6/lumen/public/volunteers/${volunteerID}`)
    ...
    function updateVolunteer(event) {
        ...
        const url = `http://localhost/AnonyGhosts_FoundationSixty6/lumen/public/volunteers/edit/${volunteerID}`
        const thisform = this
