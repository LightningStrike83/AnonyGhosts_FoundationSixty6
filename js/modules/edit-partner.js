export function editPartner() {
    ...
    const partnerPosts = Vue.createApp({
        created(){
            fetch(`http://localhost/AnonyGhosts_FoundationSixty6/lumen/public/partners/${partnerID}`)
    ...
    function updatePartner(event) {
        ...
        const url = `http://localhost/AnonyGhosts_FoundationSixty6/lumen/public/partners/edit/${partnerID}`
        const thisform = this
