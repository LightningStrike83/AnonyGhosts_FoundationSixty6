export function editCareer() {
    ...
    const careerPosts = Vue.createApp({
        created(){
            fetch(`http://localhost/AnonyGhosts_FoundationSixty6/lumen/public/careers/${careerID}`)
    ...
    function updateCareer(event) {
        ...
        const url = `http://localhost/AnonyGhosts_FoundationSixty6/lumen/public/careers/edit/${careerID}`
        const thisform = this
