export function editBlogPost() {
    ...
    const blogPosts = Vue.createApp({
        created(){
            fetch(`http://localhost/AnonyGhosts_FoundationSixty6/lumen/public/blog_posts/${blogPostID}`)
    ...
    function updateBlogPost(event) {
        ...
        const url = `http://localhost/AnonyGhosts_FoundationSixty6/lumen/public/blog_posts/edit/${partnerID}`
        const thisform = this
